// Write temporary resume data here to test the AI service

export const resume =`
PROFESSIONAL SUMMARY
Enthusiastic Computer Science student specializing in Artificial Intelligence and Machine Learning with hands-on
experience in full-stack development and AI-powered applications. Skilled in building scalable web applications using
modern technologies including React.js, Node.js, TailwindCSS, Generative AI And Prompt Engineering. Passionate about
solving real-world problems through innovative projects, hackathons, and continuous learning in software engineering
and AI systems.
EXPERIENCE
Hackathons and Technical Events 2024 – Present Developer Participant
India
• Participated in multiple online and offline hackathons, collaborating with teams to design and develop innovative
software solutions.
• Built full-stack applications under limited time constraints using technologies and AI Tools such as React, Node.js,
Python, MongoDB, and Claude Code.
• Improved practical knowledge of rapid prototyping, debugging, and product development while solving real-world
problems.
• Presented technical solutions to judges and peers, strengthening communication and teamwork skills.

SKILLS
Programming Languages: C, Python, JavaScript
Web Languages: HTML, CSS, React.js, TailwindCSS, Node.js,
Databases: MongoDB, Supabase, Firebase, MySQL
Tools and Platforms: Git, GitHub, Postman, IDE( VS Code, Antigravity, Cursor ), Google Stitch, Claude Code.
`
export const selfDescription =`
I am a Computer Science student with a strong foundation in software engineering and a passion for building
innovative applications. I have actively participated in hackathons and technical events, where I have honed my
skills in rapid prototyping, debugging, and product development. My technical expertise includes programming
languages such as C, Python, and JavaScript, along with web development technologies like React.js, Node.js, and
TailwindCSS. I am also proficient in using various tools and platforms, including Git, GitHub, Postman, and IDEs
like VS Code, Antigravity, and Cursor. I am a quick learner and enjoy solving real-world problems through
technology.

Aditya Sharma
Phone +91 90016 77070| Envelope [adityasharma4131@gmail.com](mailto:adityasharma4131@gmail.com)|
